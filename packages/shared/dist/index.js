...
export const punishmentOptions = ["timeout", "kick", "ban", "log_only"];
...
export const defaultGuildConfig = (guildId) => guildConfigSchema.parse({
    guildId,
    antiNuke: {},
    music: {},
    welcome: {},
...
export const isStaffOrOwner = (userId, ownerIds, memberRoleIds, staffRoleIds) => ownerIds.includes(userId) || memberRoleIds.some((roleId) => staffRoleIds.includes(roleId));
